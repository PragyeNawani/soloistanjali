    ...
    const emailHtml = `
      ...
      <html>
        ...
        <body>
          ...
          <div class="footer">
            <p>CHORDS Studio | Music Lessons for All Ages</p>
            <p>If you have any questions, reply to this email or contact us at support@chordsstudio.com</p>
          </div>
        </body>
      </html>
    `;
    ...
    const emailHtml = `
      ...
      <html>
        ...
        <body>
          ...
          <div class="footer">
            <p>CHORDS Studio | Music Lessons for All Ages</p>
            <p>If you have any questions about these changes, reply to this email or contact us at support@chordsstudio.com</p>
          </div>
        </body>
      </html>
    `;

...
export default function ChordsStudioPage() {
  ...
  const testimonials = [
    { name: "Vikaas tuteja", text: "Anjali is a brilliant pianist. She not only focusses on technique but also has the habit of listening beautifully to her students. She made me familiar with the language of music- Melody, Harmony, Rhythm, Chords, Scales, Voicings. She introduced me to different genres of music like Jazz, Classical, Rock, Pop, Bee Bob. The anatomy of a piece ,how to be visualized was taught to me. As a coach , mentor and a piano guide she brought the curiosity and build the persistence to learn piano. It has been a journey with so my learnings and continuous improvisation.", firstname: "Vikaas" },
    { name: "Shanaya verma", text: "I have always wanted to learn piano but was not able to start. Then I connected with Anjali and initially i was learning through her tutorials which gave me a little confidence to start learning consistently. I am glad that I started it was the best decision I made. If you want to learn piano dont think twice and join soloistanjali.", firstname: "Shanaya" },
    { name: "Deepak Sharma", text: "Amazing lessons and her teaching approach is really different which helps you gain confidence bit by bit. Highly recommended", firstname: "Chris" },
    { name: "Vaani ahuja", text: "I have made so much progress with Anjali’s lessons. As a working professional I was looking for a teacher who can be a bit flexible with scheduling and still effective. Her teaching style makes you piano learning feel very easy. Great experience!", firstname: "Vaani" },
    { name: "Vikaas tuteja", text: "Anjali is a brilliant pianist. She not only focusses on technique but also has the habit of listening beautifully to her students. She made me familiar with the language of music- Melody, Harmony, Rhythm, Chords, Scales, Voicings. She introduced me to different genres of music like Jazz, Classical, Rock, Pop, Bee Bob. The anatomy of a piece ,how to be visualized was taught to me. As a coach , mentor and a piano guide she brought the curiosity and build the persistence to learn piano. It has been a journey with so my learnings and continuous improvisation.", firstname: "Vikaas" },
    { name: "Shanaya verma", text: "I have always wanted to learn piano but was not able to start. Then I connected with Anjali and initially i was learning through her tutorials which gave me a little confidence to start learning consistently. I am glad that I started it was the best decision I made. If you want to learn piano dont think twice and join soloistanjali.", firstname: "Shanaya" },
    { name: "Deepak Sharma", text: "Amazing lessons and her teaching approach is really different which helps you gain confidence bit by bit. Highly recommended", firstname: "Chris" },
    { name: "Vaani ahuja", text: "I have made so much progress with Anjali’s lessons. As a working professional I was looking for a teacher who can be a bit flexible with scheduling and still effective. Her teaching style makes you piano learning feel very easy. Great experience!", firstname: "Vaani" },
  ...
  return (
    <div className="min-h-screen bg-white">
      {navani && <>
        <div className={`bg-blue-50 border-2 border-black h-10 w-10 fixed bottom-20 right-4 sm:bottom-24 sm:right-8 z-50 rounded-full z-50 flex justify-center items-center cursor-pointer ${isLaunching ? "rocket-launch" : ""
      ...
      <section className="relative h-screen bg-cover bg-center" style={{
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4">
          ...
          <div className="text-xs text-center md:text-lg text-left lg:text-2xl mb-2 w-[50%]"> Learn MUSIC anytime, anywhere</div>
      ...
      <section className="py-20 px-8 overflow-hidden">
        <motion.h2 ref={navref} className="text-4xl font-bold text-center mb-16">
          Trusted by <span className="text-blue-600">Learners</span>
        </motion.h2>

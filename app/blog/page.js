  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-amber-50 to-stone-100 py-16 flex items-center justify-center">
        <div className="text-amber-900 text-xl">Loading blogs...</div>
      </div>
    );
  }
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="relative">
              ...
              <select
                ...
                className="pl-10 pr-8 py-3 border border-amber-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 appearance-none bg-white cursor-pointer"
              >
                {categories.map((cat) => (
          ...
          {(category !== 'all' || searchTerm) && (
            <div className="flex items-center gap-2 mt-4">
              ...
              <button
                ...
                className="text-amber-900 text-sm hover:underline ml-2"
              >
                Clear all
              </button>
            </div>
